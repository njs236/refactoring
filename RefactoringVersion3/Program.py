...
your acknowledgement) in some activities", "ERP view flows naturally")
    ...
    def _textSave(self):
        theLines = []
        allRecords = self._theColl.displayAllRecords()
...
class Command(cmd.Cmd):
    ...
    def do_view_records(self, arg):
        ...
        """
        self._myController._viewRecords()
    ...
    def do_graphic_gender_pie_chart(self, arg):
        ...
        """
        self._myController._printGenderData()
    ...
    def do_select_rec(self, arg):
        ...
        """
        self._myController._selectRecord(arg)
    ...
    def do_select_option(self, arg):
        ...
        """
        self._myController._selectOption(arg)
...
".format(added, report))
    ...
    def do_text_save(self, arg):
        ...
        if not os.path.isfile(arg):
            try:
                theFile = open(arg, 'w')
                theLines = self._myController._textSave()
...
Please, enter a new file when using serial_save\n")
    ...
    def do_edit_age(self, arg):
        ...
        arg: [0-9]{2}
        """
        self._myController._editAge(arg)
    ...
    def do_edit_sales(self, arg):
        ...
        arg: [0-9]{3}
        """
        self._myController._editSales(arg)
    ...
    def do_edit_bmi(self, arg):
        ...
        """
        self._myController._editBmi(arg)
    ...
    def do_edit_income(self, arg):
        ...
        arg: [0-9]{3}
        """
        self._myController._editIncome(arg)
